...
def __create_raw_mbnetv3_mini(img_filepath, mean_rgb, div, req_bgr_raw, save_uint8):
...
def convert_img(src,dest,size,resize_type):
    print("Converting images for mobilenet v3 mini network.")
    ...
    for root,dirs,files in os.walk(dest):
        for jpgs in files:
            ...
            if('.jpg' in src_image):
                ...
                __create_raw_mbnetv3_mini(src_image,mean_rgb,128,False,True)
